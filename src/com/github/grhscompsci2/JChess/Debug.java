...
import com.github.grhscompsci2.JChess.util.listeners.PrimaryColorListener;
import com.github.grhscompsci2.JChess.util.listeners.SecondaryColorListener;
...
public class Debug extends JPanel {
  ...
  public Debug() {
    ...
    layout.putConstraint(
        ...
        10,
        SpringLayout.EAST,
        secondaryColorValue); // 10 away from right
  }
  ...
  private void setupPrimary() {
    ...
    layout.putConstraint(
        ...
        10,
        SpringLayout.NORTH,
        this); // 10 away from top
    layout.putConstraint(
        SpringLayout.WEST,
        primaryColorLabel,
        10,
        SpringLayout.WEST,
        this); // 10 away from side
    ...
    layout.putConstraint(
        ...
        0,
        SpringLayout.NORTH,
        primaryColorLabel); // top aligned with label
    layout.putConstraint(
        SpringLayout.WEST,
        primaryColorValue,
        3,
        SpringLayout.EAST,
        primaryColorLabel); // 3 away from label
  ...
  private void setupSecondary() {
    ...
    layout.putConstraint(
        ...
        10,
        SpringLayout.SOUTH,
        primaryColorLabel); // 10 away from label
    layout.putConstraint(
        SpringLayout.WEST,
        secondaryColorLabel,
        0,
        SpringLayout.WEST,
        primaryColorLabel); // left aligned with label
    ...
    layout.putConstraint(
        ...
        0,
        SpringLayout.NORTH,
        secondaryColorLabel); // top aligned with label
    layout.putConstraint(
        SpringLayout.WEST,
        secondaryColorValue,
        3,
        SpringLayout.EAST,
        secondaryColorLabel); // 3 away from label
  ...
  private void setupGameStarter() {
    ...
    layout.putConstraint(
        ...
        10,
        SpringLayout.SOUTH,
        secondaryColorLabel); // 10 away from label
    layout.putConstraint(
        SpringLayout.WEST,
        gameStarter,
        0,
        SpringLayout.WEST,
        secondaryColorLabel); // left aligned with label
    add(gameStarter);
  }
}
